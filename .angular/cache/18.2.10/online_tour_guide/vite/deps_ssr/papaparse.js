    ...
    (function(root, factory) {
      ...
      function ChunkStreamer(config) {
        ...
        function replaceConfig(config2) {
          ...
          if (!config2.step && !config2.chunk) configCopy.chunkSize = null;
      ...
      function ParserHandle(_config) {
        ...
        function fillHeaderFields() {
          ...
          function addHeader(header, i2) {
            if (isFunction(_config.transformHeader)) header = _config.transformHeader(header, i2);
            _fields.push(header);
          }
      ...
      function Parser(config) {
        ...
        this.parse = function(input, baseIndex, ignoreLastRow) {
          ...
          function finish(value2) {
            ...
            if (typeof value2 === "undefined") value2 = input.substring(cursor);
            row.push(value2);
            cursor = inputLen;
            pushRow(row);
